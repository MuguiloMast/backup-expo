...
import java.util.Scanner; //import o Scanner

import model.Estoque; // importa o Estoque
import model.Produto; // importa o Produto

public class Main {
    private static Estoque estoque = new Estoque(); // cria um novo estoque
    private static Scanner scanner = new Scanner(System.in); // cria o scanner

    public static void main(String[] args) {
        boolean executando = true; // enquanto executando for TRUE... (ele continuará executando)

        // Pré-cadastrar alguns produtos para teste
        EstoqueExemplo();

        while (executando) {
            exibirMenu(); // exibe nosso menu pro usuario
            int opcao = lerOpcao();
    ...
    private static void EstoqueExemplo() {
